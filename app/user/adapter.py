...
class DefaultOverrideAccountAdapter(DefaultSocialAccountAdapter):
    def pre_social_login(self, request, sociallogin):
        ...
        try:
            ...
            return        # if it does, connect this new social login to the existing user        sociallogin.connect(request, user)
    def save_user(self, request, sociallogin, form=None):
        ...
        u.is_active = True   
        u.verified = True        # u.display_name = f'{}'        u.save()
        return u   
